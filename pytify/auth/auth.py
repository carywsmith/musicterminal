...
def _refresh_access(auth_key, refresh_token):
    ...
    access_token = content.get('token_type', None)
...
def _authorization_code(conf):
    ...
    current_dir = os.path.abspath(os.current_dir)
...
def authenticate(conf):
    if conf.auth_method == AuthMethod.CLIENT_CREDTIALS:
